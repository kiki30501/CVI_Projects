...
#define  PANEL_DIN_0                      12      /* control type: radioButton, callback function: send_commands */
#define  PANEL_DIN_1                      13      /* control type: radioButton, callback function: send_commands */
#define  PANEL_DIN_2                      14      /* control type: radioButton, callback function: send_commands */
#define  PANEL_DIN_3                      15      /* control type: radioButton, callback function: send_commands */
#define  PANEL_DIN_4                      16      /* control type: radioButton, callback function: send_commands */
#define  PANEL_DIN_5                      17      /* control type: radioButton, callback function: send_commands */
#define  PANEL_DIN_6                      18      /* control type: radioButton, callback function: send_commands */
#define  PANEL_DIN_7                      19      /* control type: radioButton, callback function: send_commands */
...
#define  PANEL_ANALOG_IN_0                22      /* control type: scale, callback function: send_commands */
#define  PANEL_ANALOG_IN_1                23      /* control type: scale, callback function: send_commands */
...
int  CVICALLBACK send_commands(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
