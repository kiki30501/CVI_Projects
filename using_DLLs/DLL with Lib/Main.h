...
#define  PANEL_COMMANDBUTTON              3       /* control type: command, callback function: MainPrint */
...
int  CVICALLBACK MainPrint(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
